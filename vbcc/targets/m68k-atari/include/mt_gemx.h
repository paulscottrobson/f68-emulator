/*
 *  $Id: mt_gemx.h,v 1.2 2015/07/28 08:58:59 phx Exp $
 *
...
short	mt_xfrm_popup 	(OBJECT *tree, short x, short y, short firstscrlob, short lastscrlob, short nlines,
						 void (*init)(struct POPUP_INIT_args),
...
/** TODO */
typedef void (*UTXT_FN)(struct UTXT_FN_args);
...
/** TODO */
typedef short (*XFSL_FILTER)(char *path, char *name, GEMLIB_XATTR *xattr);
...
typedef long (*PRN_SWITCH)(DRV_ENTRY *drivers, PRN_SETTINGS *settings, PRN_ENTRY *old_printer, PRN_ENTRY *new_printer);
...
/** TODO */
typedef long (*PDLG_HNDL)(struct PDLG_HNDL_args);
...
typedef void  (*SLCT_ITEM)(struct SLCT_ITEM_args);		/**< TODO */
typedef short (*SET_ITEM)(struct SET_ITEM_args);		/**< TODO */
 ...
 */
typedef short (*HNDL_OBJ)(struct HNDL_OBJ_args);
