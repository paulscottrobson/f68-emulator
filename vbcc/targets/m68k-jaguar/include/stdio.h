/* stdio.h ATARI Jaguar specific version */
#ifndef __STDIO_H
#define __STDIO_H 1
...
/* Has to be user implemented or defined by using sjaglib */
extern int jagopen(const char *,const char *);
extern void jagclose(int);
extern size_t jagread(int,char *,size_t);
extern size_t jagwrite(int,const char *,size_t);
extern long jagseek(int,long,int);
extern int jagisatty(int); 
